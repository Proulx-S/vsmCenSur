...
|---|---|---|---|
| vsmCenSur (this) | https://github.com/Proulx-S/vsmCenSur.git | dev | `f013b8cd2561adcdfa96120bb1e36e3608a82444` |
...
The figure sections are the cells after it; set `printIt = 1` in a section to
...
Each output is written as `.fig`, `.svg`, `.eps`, `.png`.
